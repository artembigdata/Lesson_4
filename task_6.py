...
условие его завершения. Например, в первом задании выводим целые числа, начиная с 3,
...
print('программа генерирует целые числа , начиная с указанного. для генерации '
      'следующего числа необходимо нажать enter, для выхода - q')
for i in count(int(input('введите стартовое число: '))):
    print(i, end='')
    quit  = input()
    if quit == 'q':
        break
u_list = input('введите список: ').split()
iter = cycle(u_list)
quit = None
